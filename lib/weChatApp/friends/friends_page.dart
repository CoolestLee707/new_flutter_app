...
class _FriendsPageState extends State<FriendsPage> {
  ...
  final List<Friends> _headerData = [
    Friends(
        imageAssets: 'lib/assets/weChat/weChat_newFriend.png', name: '新的朋友'),
    Friends(imageAssets: 'lib/assets/weChat/weChat_manyChats.png', name: '群聊'),
    Friends(imageAssets: 'lib/assets/weChat/weChat_tag.png', name: '标签'),
    Friends(imageAssets: 'lib/assets/weChat/weChat_public.png', name: '公众号'),
  ];
        ...
        actions: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: const Image(
                image: AssetImage("lib/assets/weChat/WeChat_friends_add.png"),
                width: 25,
              ),
            ),
          )
